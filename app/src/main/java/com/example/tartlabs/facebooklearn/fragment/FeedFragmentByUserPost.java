...
import com.example.tartlabs.facebooklearn.fbHelper.UserHelper;
 ...
 */
public class FeedFragmentByUserPost extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_feed_fragment_by_user_post, container, false);
    }
    ...
    private void loadLatestPosts() {
        showProgress();
        UserHelper.getLatestFeedPosts(10)
                .addOnSuccessListener(this::onLatestFeedSuccess);
    }

    private void onLatestFeedSuccess(ArrayList<String> feedsList) {
        hideProgress();
    ...
    public static Observable<List<Post>> getPostDate() {
        List<Post> postList = new ArrayList<>();
        Observable<Post> posts =
                PostHelper.getSingleOldPosts(userType);

        return Observable.zip(posts,
                (post, otherWallSuccess, IsFollowingSuccess) -> {
                    postList.add(post);
                    return po;
                });
    }
